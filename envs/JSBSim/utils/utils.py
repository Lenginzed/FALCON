...
def parse_config(filename):
    ...
    Args:
        filename (str): config file name under ``envs/JSBSim/configs`` or
            an explicit YAML path. Explicit paths are used by FALCON smoke
            training to consume generated scenario YAMLs without modifying the
            MAPPO runner or algorithm logic.
